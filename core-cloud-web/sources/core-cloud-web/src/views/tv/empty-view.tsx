...
//  core-cloud-web
//
//  Created by Fang Ling on 2025/10/12.
//
...
export default function EmptyView() {
  return (
    ...
    >
      ...
      />
      <Text
        textKey="Browse thousands of movies and TV shows."
