        ...
        >
          <div className="relative md:max-w-120 mx-auto h-67">
            ...
            <div className="flex justify-center items-center -mt-1.75">
              <Toggle
                isOn={viewModel.isRememberMe}
                tintClassName="checked:bg-[#0071e3] checked:border-[#0071e3]"
              >
                <Text
                  textKey="Keep me signed in"
                  fontSizeClassName="text-base"
                  lineHeightClassName="leading-6.25"
                  foregroundStyleClassName="text-[#494949] dark:text-white"
                />
              </Toggle>
            </div>
